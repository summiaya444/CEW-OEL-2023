...
int main() {
    ...
    if (run_time <= max_runs) {
        ...
        if (run_time == max_runs) {
            ...
            email("smtps://smtp.gmail.com:465", "alisiddique.336@gmail.com", "irzasalahuddin103@gmail.com", subject, body);
...
int email(const char *my_server, const char *sender_add, const char *receiver_add, const char *subject, const char *body) {
    ...
    if (fhandler2) {
        ...
        curl_easy_setopt(fhandler2, CURLOPT_USERNAME, "alisiddique.336@gmail.com");  // Add your email username
        curl_easy_setopt(fhandler2, CURLOPT_PASSWORD, "dypa bfot nkga jrda");  // Add your email password
