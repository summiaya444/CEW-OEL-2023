...
int get_run_time() {
    ...
    if (run_file != NULL) {
        read_data=fscanf(run_file, "%d", &run_time);
        fclose(run_file);
        return read_data;
    }
    else {
...
int main() {
    ...
    int count=get_run_time();  // Assuming get_run_time is defined somewhere
    ...
    if (count== max_runs) {
        ...
        email("smtps://smtp.gmail.com:465", "irzasalahuddin103@gmail.com", "irzasalahuddin103@gmail.com", subject, body);
...
int email(const char *my_server, const char *sender_add, const char *receiver_add, const char *subject, const char *body) {
    ...
    if (fhandler2) {
        ...
        curl_easy_setopt(fhandler2, CURLOPT_USERNAME, "irzasalahuddin103@gmail.com");  // Add your email username
        curl_easy_setopt(fhandler2, CURLOPT_PASSWORD, "hellohibyebye444");  // Add your email password
